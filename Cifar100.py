...
if os.path.exists('./best_model.h5') and not DO_TRAIN:
    model = ks.models.load_model('./best_model.h5')
else:
    model = ks.Sequential([
    ...
    callbacks = [
        # ks.callbacks.ModelCheckpoint('best_model.h5', save_best_only=True),
